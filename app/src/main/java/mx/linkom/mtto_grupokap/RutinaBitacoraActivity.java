...
public class RutinaBitacoraActivity extends  mx.linkom.mtto_grupokap.Menu {
    private Configuracion Conf;
    JSONArray ja1,ja2;
    TextView Actividad,Area,Fecha,Observaciones11,Observaciones22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Guardar_Nota.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(RutinaBitacoraActivity.this);
    ...
    public void traerRutina() {
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/rutinas_detalle.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
    ...
    public void btnAdjuntarImg1() {
        final PopupMenu popupMenu = new PopupMenu(RutinaBitacoraActivity.this, Foto_Antes);
    ...
    public void btnAdjuntarImg2() {
        final PopupMenu popupMenu = new PopupMenu(RutinaBitacoraActivity.this, Foto_Despues);
        popupMenu.getMenuInflater().inflate(R.menu.popup_menu_image, popupMenu.getMenu());
        popupMenu.show();
    ...
    public  void traerBitacora(){
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/rutinas_bitacora.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    if(ja2.getString(6).equals("")) {
                        ...
                        storageReference.child(Conf.getPin()+"/antes/"+ja2.getString(6))
                            ...
                            public void onSuccess(Uri uri) {
                                Glide.with(RutinaBitacoraActivity.this)
                                        .load(uri)
    ...
    public void insertarNota() {
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/rutinas_nota.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ok",new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    Intent i = new Intent(getApplicationContext(), RutinaBitacoraActivity.class);
                                    startActivity(i);
                                    finish();
                                }
                            }).create().show();
    ...
    public void insertarAntes() {
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/rutinas_antes.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void insertarDespues() {
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/rutinas_despues.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void terminar() {
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/rutinas_terminar.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void upload1() {
        ...
        uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
            ...
            @Override
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(RutinaBitacoraActivity.this,"Fallado", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.mtto_grupokap.DashboardActivity.class);
