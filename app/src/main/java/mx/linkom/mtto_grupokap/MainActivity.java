...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mx.linkom.mtto_grupokap.Global.TOKEN.equals("")) {
            mx.linkom.mtto_grupokap.Global.TOKEN = FirebaseInstanceId.getInstance().getToken();
            Log.d(TAG, "Token Generado: " + mx.linkom.mtto_grupokap.Global.TOKEN);
        }
    ...
    public void PIN() {
        if (Pin.toString().isEmpty()) {
            ...
            String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/pin.php";
    ...
    public void Residencial() {
        ...
        String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/residencial.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void Login() {
        ...
        if (User.toString().isEmpty()) {
            ...
            String URL = "https://2210.kap-adm.mx/plataforma/casetaV2/controlador/2210_mtto/session.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.length() > 0) {
                        try {
                            ...
                            mx.linkom.mtto_grupokap.Global.USER = ja1.getString(12);
                            mx.linkom.mtto_grupokap.Global.PASS = ja1.getString(13);
                            mx.linkom.mtto_grupokap.Global.EMAIL = ja1.getString(8);

                            if(ja1.getString(2).equals("1")){

                                Intent i = new Intent(getApplication(), mx.linkom.mtto_grupokap.DashboardAdminActivity.class);
                                startActivity(i);
                                finish();
                            }else if(ja1.getString(2).equals("2")){

                                Intent i = new Intent(getApplication(), mx.linkom.mtto_grupokap.DashboardActivity.class);
                                startActivity(i);
                                finish();
                            }
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("Token", mx.linkom.mtto_grupokap.Global.TOKEN.trim());
    ...
    protected void onStart() {
        ...
        if(fUser != null){
            if( Conf.getUserTipo().equals("1")){
                Intent i = new Intent(getApplicationContext(), mx.linkom.mtto_grupokap.DashboardAdminActivity.class);
                startActivity(i);
                finish();
            }else if(Conf.getUserTipo().equals("2")){
                Intent i = new Intent(getApplicationContext(), mx.linkom.mtto_grupokap.DashboardActivity.class);
                startActivity(i);
                finish();
            }
